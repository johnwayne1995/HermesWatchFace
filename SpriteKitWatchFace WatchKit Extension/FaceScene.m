...
//    }
	...
	if (self.dateStyle != DateStyleNone)
	{
		...
		if (self.dateQuadrant == DateQuadrantRight)
			...
			numberLabel.position = CGPointMake(0, -(61+numeralDelta));
...
//    }
	...
	if (self.dateStyle != DateStyleNone)
	{
		...
		if (self.dateQuadrant == DateQuadrantRight)
			...
			numberLabel.position = CGPointMake(0, -(54+numeralDelta));
...
-(void)setupColors
{
	...
	switch (self.theme) {
        case ThemeMarques://default
        {
            colorRegionColor = [SKColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.000];
            faceBackgroundColor = [SKColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.000];
            inlayColor = [SKColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.000];//指针内
            majorMarkColor = [SKColor colorWithWhite:0.0 alpha:0.0];//主刻度
            minorMarkColor = [faceBackgroundColor colorWithAlphaComponent:0.0];//辅刻度
            handColor = [SKColor colorWithRed:0.812 green:0.239 blue:0.227 alpha:1.0];
            textColor = [SKColor colorWithRed:0.7 green:0.718 blue:0.761 alpha:0.8];
            secondHandColor = [SKColor colorWithWhite:0.9 alpha:1];
            
//            alternateTextColor = [SKColor colorWithRed:0.69 green:0.7098 blue:0.749 alpha:1.0];
            alternateMinorMarkColor = [colorRegionColor colorWithAlphaComponent:0.0];
            alternateMajorMarkColor = [SKColor colorWithWhite:0 alpha:0.0];
            self.useBackgroundImageOverlay = YES;
            self.useMasking = NO;
            break;
        }
		...
		{
			colorRegionColor = [SKColor colorWithRed:0.118 green:0.188 blue:0.239 alpha:1.000];//[SKColor colorWithRed:0.87 green:0.831 blue:0.753 alpha:0.500];
			faceBackgroundColor = [SKColor colorWithRed:0.87 green:0.831 blue:0.753 alpha:1.00];//[SKColor colorWithRed:0.118 green:0.188 blue:0.239 alpha:1.000];
            ...
            alternateTextColor = [SKColor colorWithWhite:1.0 alpha:1];
              self.useBackgroundImageOverlay = YES;
			break;
		}
		case ThemeNavy:
...
//        }
		...
		case ThemeSculley:
		{
			...
			textColor = [SKColor whiteColor];//[SKColor colorWithRed:0.080 green:0.300 blue:0.082 alpha:1.000];
			secondHandColor = majorMarkColor;
              self.useBackgroundImageOverlay = YES;
			break;
		}
		case ThemeKitty:
		{
			...
			textColor = [SKColor whiteColor];//[SKColor colorWithRed:0.159 green:0.171 blue:0.406 alpha:1.000];
		...
		case ThemeStrawberry:
		{
			...
			faceBackgroundColor =  [SKColor colorWithRed:0.361 green:0.235 blue:0.271 alpha:1.000];//[SKColor colorWithWhite:0.9 alpha:1];
			inlayColor = colorRegionColor;
			majorMarkColor = [SKColor colorWithWhite:0.9 alpha:1.0];
			minorMarkColor = majorMarkColor;
			handColor = [SKColor whiteColor];
		...
		case ThemePawn:
		{
			...
			alternateTextColor =  [SKColor colorWithWhite:0.6 alpha:1];//colorRegionColor;
		...
		case ThemeVox:
		{
			colorRegionColor = [SKColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.000];
			faceBackgroundColor = [SKColor colorWithRed:0.224 green:0.204 blue:0.565 alpha:1.000];
			inlayColor = faceBackgroundColor;
			majorMarkColor = [SKColor colorWithRed:0.324 green:0.304 blue:0.665 alpha:0.000];
			minorMarkColor = [SKColor colorWithWhite:0.831 alpha:0.5];
			handColor = [SKColor whiteColor];
			textColor = [SKColor colorWithWhite:0.5 alpha:1.000];
			secondHandColor = [SKColor colorWithRed:0.914 green:0.486 blue:0.949 alpha:1.000];
			
			alternateTextColor = [SKColor colorWithWhite:0.2 alpha:1.000];
			alternateMinorMarkColor = [SKColor colorWithWhite:1.0 alpha:0.5];
			alternateMajorMarkColor = [SKColor colorWithRed:0.914 green:0.0 blue:0.0 alpha:0.000];
              self.useBackgroundImageOverlay = YES;
			self.useMasking = NO;
			break;
		}
